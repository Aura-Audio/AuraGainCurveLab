/**
 * AudioEngine — Self-contained gain-curve track
 */
...
export class AudioEngine {
  ...
  async start() {
    ...
    this.segmentT0 = this.audioCtx.currentTime;
    this.running = true;
    this.schedulerTick();
  ...
  _scheduleCycle(startTime, duration) {
    ...
    // 16-point curve sampling for smooth non-linear shapes
    const steps = 16;
